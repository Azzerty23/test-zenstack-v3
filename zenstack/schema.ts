...
export const schema = {
    ...
    models: {
        ...
        Profile: {
            ...
            computedFields: {
                agePlus2(): OperandExpression<number> {  // Type should be: OperandExpression<number | null>
                    throw new Error("This is a stub for computed field");
                }
            }
        },
        Post: {
            ...
            computedFields: {
                newTitle(): OperandExpression<string> {
                    throw new Error("This is a stub for computed field");
                },
                isNotPublished(): OperandExpression<boolean> {
                    throw new Error("This is a stub for computed field");
                }
            }
        }
